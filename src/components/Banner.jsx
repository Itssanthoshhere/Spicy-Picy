...
const Banner = () => {
    return (
        ...
        items-center bg-cover bg-center text-white text-center'
        ...
        >
            ...
            <div className='relative z-10 w-full md:w-2/4 bg-black/50 p-5 mx-5 space-y-5 rounded-md'>
                ...
                {/* Marketing-friendly description */}
                <p className='text-sm font-light'>
                    Explore the rich flavors of our handpicked spices, crafted to bring warmth, aroma, and taste to every meal.
                </p>

                {/* Call-to-action button */}
                <button className='bg-orange-500 px-2 py-1 rounded-lg hover:bg-white hover:text-black transition
